...
function to_jalali($value){
$show = explode("-",$value);
return gregorian_to_jalali($show[0],$show[1],$show[2],date("Y-m-d"));
}
function to_gregorian($value){
$show = explode("-",$value);
return jalali_to_gregorian($show[0],$show[1],$show[2],date("Y-m-d"));
}
...
function to_start_jalali($value){
$get = to_jalali($value);
$show = explode("-",$get);
return jalali_to_gregorian($show[0],$show[1],"01",date("Y-m-d"));
}
function to_end_jalali($value){
$get = to_jalali($value);
$show = explode("-",$get);
return jalali_to_gregorian($show[0],$show[1],getMonth($show[0],$show[1]),date("Y-m-d"));
}